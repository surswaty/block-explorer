...
const Blocks = () => {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    <div className="">
      <div>
        ...
        <div className="text-black">Fee Recipient 
  ...
  return (
    <div className="bg-light_grey h-[638px] mx-4 mt-[-65px] flex flex-col justify-between rounded-lg border-[1px] border-black border-opacity-25">
