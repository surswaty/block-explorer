...
const Transactions = () => {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    <div className="">
      <div>
        ...
        <div className="text-black text-sm">From 
  ...
  return (
    <div className="bg-light_grey mx-4 mt-6 flex flex-col justify-between rounded-lg border-[1px] border-black border-opacity-25">
